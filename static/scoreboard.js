...
function increase_score(id) {
  ...
  $.ajax({
    ...
    success: function (result) {
      scoreboard = result.scoreboard; // Update the global scoreboard with the updated data
      display_scoreboard(scoreboard); // Update the front-end with the updated scoreboard
    },
